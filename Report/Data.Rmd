...
#weather$time = paste(weather$Year, weather$Month, weather$Day, sep = "-")
#weather$time = paste(weather$time, weather$Hour, sep = " ")
#weather$time = paste(weather$time, weather$Minute, sep = ":")
...
weather <- weather[weather$Date >= "2022-03-09 16:00:00" & weather$Date <= "2022-03-22 13:40:00
",] # décalage horaire = mettre 1 h de plus 
