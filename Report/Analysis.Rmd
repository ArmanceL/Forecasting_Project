...
```{r}
FIT6 <- Gland_fin_tsibble %>%
model(ETS(Bike_Grand_Rue ~ error("A") + trend("N", alpha=0.96) + season("A")))
...
```{r}
FIT.6 <- Gland_fin_tsibble %>%
model(ETS(Ebike_Grand_Rue ~ error("A") + trend("N", alpha=1) + season("A")))
...
```{r}
FIT7 <- Gland_fin_tsibble %>%
model(ETS(Bike_La_Falaise ~ error("A") + trend("N", alpha=0.91) + season("A")))
...
```{r}
FIT.7 <- Gland_fin_tsibble %>%
model(ETS(Ebike_La_Falaise ~ error("A") + trend("N", alpha=0.98) + season("A")))
...
```{r}
FIT8 <- Gland_fin_tsibble %>%
model(ETS(Bike_La_Lignière ~ error("A") + trend("N", alpha=0.94) + season("A")))
...
```{r}
FIT.8 <- Gland_fin_tsibble %>%
model(ETS(Ebike_La_Lignière ~ error("A") + trend("N", alpha=0.96) + season("A")))
...
```{r}
FIT9 <- Gland_fin_tsibble %>%
model(ETS(Bike_Eikenott ~ error("A") + trend("N", alpha=0.99) + season("A")))
...
```{r}
FIT10 <- Gland_fin_tsibble %>%
model(ETS(Bike_La_Dôle ~ error("A") + trend("N", alpha=0.99) + season("A")))
...
```{r}
FIT.10 <- Gland_fin_tsibble %>%
model(ETS(Ebike_La_Dôle ~ error("A") + trend("N", alpha=1) + season("A")))
...
```{r}
FIT.11 <- Gland_fin_tsibble %>%
model(ETS(Ebike_En_Bord ~ error("A") + trend("N", alpha=0.93) + season("A")))
