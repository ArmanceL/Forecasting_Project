...
```
```{r}
vis_miss(Gland_fin_2)
which(is.na(Gland_fin_2), arr.ind = TRUE)

Gland_fin_2 <- na_locf(Gland_fin_2)
```
...
```{r}
fitLT <- Gland_fin_2_tsibble %>%  model(ARIMA(Bike_Les_Tuillières))
report(fitLT)
fitLT %>% forecast(h = 233) %>% autoplot(Gland_fin_2_tsibble)

fit.LT <- Gland_fin_2_tsibble %>%  model(ARIMA(Ebike_Les_Tuillières))
report(fit.LT)
fit.LT %>% forecast(h = 233) %>% autoplot(Gland_fin_2_tsibble)

Tab1 <- predict(fit.LT, h = 233, ci = 0.90)
Tab1 <- Tab1[-c(1,3:4)]
```
...
model(ETS(Bike_Gare_Sud ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit3)
```
...
```{r}
FIT3 <- Gland_fin_tsibble %>%
model(ETS(Bike_Gare_Sud ~ error("A") + trend("N", alpha=0.95) + season("A")))
...
model(ETS(Ebike_Gare_Sud ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.3)
```
...
```{r}
FIT.3 <- Gland_fin_tsibble %>%
model(ETS(Ebike_Gare_Sud ~ error("A") + trend("N", alpha=0.95) + season("A")))
...
model(ETS(Bike_UICN ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit4)
```
...
```{r}
FIT4 <- Gland_fin_tsibble %>%
model(ETS(Bike_UICN ~ error("A") + trend("N", alpha=0.95) + season("A")))
...
model(ETS(Ebike_UICN ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.4)
```
...
```{r}
FIT.4 <- Gland_fin_tsibble %>%
model(ETS(Ebike_UICN ~ error("A") + trend("N", alpha=0.98) + season("A")))
...
model(ETS(Bike_Montoly ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit5)
```

According to the fit, we should set alpha = 0.847.
```{r}
FIT5 <- Gland_fin_tsibble %>%
model(ETS(Bike_Montoly ~ error("A") + trend("N", alpha=0.84) + season("A")))
...
model(ETS(Ebike_Montoly ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.5)
```
...
```{r}
FIT.5 <- Gland_fin_tsibble %>%
model(ETS(Ebike_Montoly ~ error("A") + trend("N", alpha=0.96) + season("A")))
...
model(ETS(Bike_Grand_Rue ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit6)
```

According to the fit, we should set alpha = 0.93.
```{r}
FIT6 <- Gland_fin_tsibble %>%
model(ETS(Bike_Grand_Rue ~ error("A") + trend("N", alpha=0.93) + season("A")))
...
model(ETS(Ebike_Grand_Rue ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.6)
```
...
```{r}
FIT.6 <- Gland_fin_tsibble %>%
model(ETS(Ebike_Grand_Rue ~ error("A") + trend("N", alpha=0.98) + season("A")))
...
model(ETS(Bike_La_Falaise ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit7)
```

According to the fit, we should set alpha = 0.88.
```{r}
FIT7 <- Gland_fin_tsibble %>%
model(ETS(Bike_La_Falaise ~ error("A") + trend("N", alpha=0.88) + season("A")))
...
model(ETS(Ebike_La_Falaise ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.7)
```

According to the fit, we should set alpha = 0.92.
```{r}
FIT.7 <- Gland_fin_tsibble %>%
model(ETS(Ebike_La_Falaise ~ error("A") + trend("N", alpha=0.92) + season("A")))
...
model(ETS(Bike_La_Lignière ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit8)
```
...
```{r}
FIT8 <- Gland_fin_tsibble %>%
model(ETS(Bike_La_Lignière ~ error("A") + trend("N", alpha=0.93) + season("A")))
...
model(ETS(Ebike_La_Lignière ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.8)
```

According to the fit, we should set alpha = 0.97.
```{r}
FIT.8 <- Gland_fin_tsibble %>%
model(ETS(Ebike_La_Lignière ~ error("A") + trend("N", alpha=0.97) + season("A")))
...
model(ETS(Bike_Eikenott ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit9)
```
...
```{r}
FIT9 <- Gland_fin_tsibble %>%
model(ETS(Bike_Eikenott ~ error("A") + trend("N", alpha=0.96) + season("A")))
...
model(ETS(Ebike_Eikenott ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.9)
```
...
```{r}
FIT.9 <- Gland_fin_tsibble %>%
model(ETS(Ebike_Eikenott ~ error("A") + trend("N", alpha=0.95) + season("A")))
...
model(ETS(Bike_La_Dôle ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit10)
```
...
```{r}
FIT10 <- Gland_fin_tsibble %>%
model(ETS(Bike_La_Dôle ~ error("A") + trend("N", alpha=0.95) + season("A")))
...
model(ETS(Ebike_La_Dôle ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.10)
```

According to the fit, we should set alpha = 0.197.
```{r}
FIT.10 <- Gland_fin_tsibble %>%
model(ETS(Ebike_La_Dôle ~ error("A") + trend("N", alpha=0.197) + season("A")))
...
model(ETS(Bike_En_Bord ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit11)
```
...
```{r}
FIT11 <- Gland_fin_tsibble %>%
model(ETS(Bike_En_Bord ~ error("A") + trend("N", alpha=0.95) + season("A")))
...
model(ETS(Ebike_En_Bord ~ error("A") + trend("N") + season("A"), opt_crit = "mse"))
coefficients(fit.11)
```
...
```{r}
FIT.11 <- Gland_fin_tsibble %>%
model(ETS(Ebike_En_Bord ~ error("A") + trend("N", alpha=0.92) + season("A")))
...
```{r}
df.gland <-Gland_fin_2[,c("Bike_Eikenott","Ebike_Eikenott","Bike_En_Bord","Ebike_En_Bord","Bike_Gare_Sud", "Ebike_Gare_Sud","Bike_La_Dôle","Ebike_La_Dôle","Bike_Grand_Rue", "Ebike_Grand_Rue","Bike_La_Falaise","Ebike_La_Falaise","Bike_La_Lignière","Ebike_La_Lignière","Bike_Les_Tuillières","Ebike_Les_Tuillières","Bike_Montoly","Ebike_Montoly","Bike_Swissquote","Ebike_Swissquote","Bike_UICN","Ebike_UICN")]

VARselect(df.gland, lag.max = 4, type = "const", season = 233)
var.model_lev <- VAR(df.gland, p = 4, type = "const", season = 233)
accuracy(var.model_lev$varresult[[1]])

var.pred <- predict(var.model_lev, n.ahead = 233, ci = 0.90)

Var.stations <- as.data.frame(var.pred["fcst"])

colnames(Var.stations) <- c("Bike_Eikenott","Lower1.1","Upper1.1","CI1.1","Ebike_Eikenott","Lower1.2","Upper1.2","CI1.2","Bike_En_Bord","Lower2.1","Upper2.1","CI2.1","Ebike_En_Bord","Lower2.2","Upper2.2","CI2.2","Bike_Gare_Sud","Lower3.1","Upper3.1","CI3.1","Ebike_Gare_Sud","Lower3.2","Upper3.2","CI3.2","Bike_La_Dôle","Lower4.1","Upper4.1","CI4.1","Ebike_La_Dôle","Lower4.2","Upper4.2","CI4.2","Bike_Grand_Rue","Lower5.1","Upper5.1","CI5.1","Ebike_Grand_Rue","Lower5.2","Upper5.2","CI5.2","Bike_La_Falaise","Lower6.1","Upper6.1","CI6.1","Ebike_La_Falaise","Lower6.2","Upper6.2","CI6.2","Bike_La_Lignière","Lower7.1","Upper7.1","CI7.1","Ebike_La_Lignière","Lower7.2","Upper7.2","CI7.2","Bike_Les_Tuillières","Lower8.1","Upper8.1","CI8.1","Ebike_Les_Tuillières","Lower8.2","Upper8.2","CI8.2","Bike_Montoly","Lower9.1","Upper9.1","CI9.1","Ebike_Montoly","Lower9.2","Upper9.2","CI9.2","Bike_Swissquote","Lower10.1","Upper10.1","CI10.1","Ebike_Swissquote","Lower10.2","Upper10.2","CI10.2","Bike_UICN","Lower11.1","Upper11.1","CI11.1","Ebike_UICN","Lower11.2","Upper11.2","CI11.2")
...
Tab.final[Tab.final < 0] <- 0     # Set negative values to 0
